...
public class JdbcReservationQueryRepository implements ReservationQueryRepository {
    ...
    JdbcReservationQueryRepository(JdbcClient jdbcClient) {
    ...
    public SA.irms.reservation.application.view.ReservationViews.ReservationOverview load(LocalDate date) {
        ...
        List<SA.irms.reservation.application.view.ReservationViews.TableView> tables = jdbcClient.sql("""
                        select dt.table_id,
                               dt.code,
                               dt.capacity,
                               dt.status,
        ...
        List<SA.irms.reservation.application.view.ReservationViews.ReservationView> reservations = jdbcClient.sql("""
                ...
                .query((rs, rowNum) -> new SA.irms.reservation.application.view.ReservationViews.ReservationView(
        ...
        List<SA.irms.reservation.application.view.ReservationViews.WaitlistView> waitlist = jdbcClient.sql("""
        ...
        return new SA.irms.reservation.application.view.ReservationViews.ReservationOverview(tables, reservations, waitlist);
    }

    public SA.irms.reservation.application.view.ReservationViews.ReservationView findReservation(UUID reservationId) {
