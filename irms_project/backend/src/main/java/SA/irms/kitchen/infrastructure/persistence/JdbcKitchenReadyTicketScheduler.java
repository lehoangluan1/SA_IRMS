...
@Component
@Order(50)
public class JdbcKitchenReadyTicketScheduler implements KitchenAutomationStep {
    private final JdbcClient jdbcClient;
    private final KitchenTimingPolicy timingPolicy;
    private final Clock clock;

    JdbcKitchenReadyTicketScheduler(JdbcClient jdbcClient, KitchenTimingPolicy timingPolicy, Clock clock) {
