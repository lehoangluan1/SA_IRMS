...
@Component
@Order(10)
public class JdbcKitchenQueuedItemScheduler implements KitchenAutomationStep {
    private final JdbcClient jdbcClient;
    private final KitchenTimingPolicy timingPolicy;
    private final Clock clock;

    JdbcKitchenQueuedItemScheduler(JdbcClient jdbcClient, KitchenTimingPolicy timingPolicy, Clock clock) {
