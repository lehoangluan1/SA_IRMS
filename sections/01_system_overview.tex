...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Đa dạng phương thức thanh toán}: Hỗ trợ tiền mặt, thẻ và ví điện tử thông qua \textsf{PaymentGateway} trong code, đồng thời phát hành biên lai qua \textsf{ReceiptDeliveryAdapter}.
    \end{itemize}
...
\textsf{PaymentGateway} & Port/adapter nội bộ & \begin{itemize}
  ...
  \item Hỗ trợ nhánh tiền mặt và nhánh tham chiếu giao dịch đã hiện thực trong code
