...
\begin{figure}[H]
\centering
\IfFileExists{anh22.jpg}{
  \includegraphics[width=0.97\linewidth,height=0.84\textheight,keepaspectratio]{anh22.jpg}
}{
...
\subsubsection{Assignment view}
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth,height=0.82\textheight,keepaspectratio]{assets/images/installview.jpg}
\label{fig:irms-dashboard}
\caption{Góc nhìn lịch trình và phân công công việc}
\end{figure}
